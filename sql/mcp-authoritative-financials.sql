...
-- ---------------------------------------------------------------------------
-- get_earnings / get_outstanding — live in sql/mcp-app-alignment.sql
-- Dated questions → load_insights_overview (same as Insights).
-- Unscoped → all-time (Today / Payments). Do not recreate the
-- load_earnings_summary wrapper here; it disagrees with Insights Year.
-- ---------------------------------------------------------------------------
