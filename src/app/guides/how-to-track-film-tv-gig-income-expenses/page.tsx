  ...
  return (
    <PublicShell>
      ...
      <article className="mx-auto max-w-2xl py-4 text-zinc-800 dark:text-zinc-200">
        ...
        <P>GigDock isn&rsquo;t tax-preparation software, but it is <strong>tax-readiness software</strong>. It keeps the work organized before tax season arrives so that when it&rsquo;s time to prepare your taxes, the numbers and records are already in one place and much easier to manage. Recording something in GigDock doesn&rsquo;t determine its tax treatment &mdash; it just makes sure nothing is lost by the time you, or whoever prepares your return, needs it.</P>
